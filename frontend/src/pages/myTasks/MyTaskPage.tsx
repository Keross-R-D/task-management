...
const TasksPage: React.FC = () => {
  ...
  const columns: any = [
    {
      accessorKey: "name",
      header: () => <div className="text-left font-semibold">Task Name</div>,
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                <h3 className="flex gap-1 font-semibold text-lg">
                  {task.name}
                </h3>
      ...
      {isFetching ? (
        <div className="p-4 overflow-hidden">
          <div className="flex justify-between items-center">
            <div className="mb-4">
              <Skeleton className="h-8 w-52 mb-2 rounded-md" />
        ...
        <ErrorState message="We couldn’t load your tasks right now. Please try again after a moment." onRetry={() => refetch()} />
      ) : (
        <div className="p-4">
          <div className="flex justify-between items-center">
            <div>
