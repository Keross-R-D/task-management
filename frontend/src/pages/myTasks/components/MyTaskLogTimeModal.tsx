...
import { useCreateMyTaskWorklogMutation } from "@/features/myTaskWorklogs/myTaskWorklogApiSlice";
...
export default function MyTaskLogTimeModal({ open, task, onClose }: Props) {
    const [createWorklog, { isLoading }] = useCreateMyTaskWorklogMutation();
    ...
    return (
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="max-w-md bg-[#0b0c10] text-gray-100 border-gray-800">
                            ...
                            <div className="mt-3 max-h-40 overflow-y-auto space-y-2 pr-2 custom-scrollbar">
                                ...
                                return (
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        type="number"
                                        step="0.25"
                                        className="w-20 h-7 text-left bg-transparent border-gray-700"
                                        value={
