...
// fieldsConfig.add(FieldsConfigDto.builder().key("projectName").label("Project
// Name").type("string").build());
// fieldsConfig.add(FieldsConfigDto.builder().key("clientName").label("Client
// Name").type("string").build());
// fieldsConfig.add(FieldsConfigDto.builder().key("managerId").label("Manager
// ID").type("string").build());
// fieldsConfig.add(
// FieldsConfigDto.builder().key("managerDelegateId").label("Manager Delegate
// ID").type("string").build());
// fieldsConfig.add(FieldsConfigDto.builder().key("startDate").label("Start
// Date").type("string").build());
// fieldsConfig.add(FieldsConfigDto.builder().key("endDate").label("End
// Date").type("string").build());
// fieldsConfig.add(FieldsConfigDto.builder().key("projectStatus").label("Project
// Status").type("string").build());
// fieldsConfig.add(FieldsConfigDto.builder().key("type").label("Type").type("string").build());
// fieldsConfig.add(FieldsConfigDto.builder().key("teamMemberIds").label("Team
// Member IDs").type("array").build());
// return fieldsConfig;
// }
...
// Optional<ConnectorConfigResponse> projectConfig =
// configService.getAllConnectorConfigs().stream()
...
// Optional<ConnectionResponse> projectConnection =
...
// } catch (Exception e) {
// log.error("Failed to create project for request {}: {}", req, e.getMessage(),
// e);
// }
// });
...
// } else {
// log.info("No new projects to save. All {} record(s) already exist.",
// requests.size());
// }
// }
